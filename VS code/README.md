...
- _**ctrl + F2**_ - substitui todos os elementos que tem o nome igual no código depois de seleciona-los.

- _**ctrl + espaço**_ - tras um texto com a explicação da opção selecionda (quando aparece a lista com várias opções de argumento)

- _**shift + alt + seta pra cima ou pra baixo**_ - duplica a linha que voce esta para cima ou para baixo

- _**ctrl + espaco**_ - sugestao de link

- _**ctrl + alt + seta pra direita**_ - ele vai dividir a tela em dois arquivos permitindo trabalhar em ambos

- _**alt + seta pra cima**_ -= move os elementos selecionados 
...
Conteúdo de apoio presente no [PDF do capítulo 2](../Content/PDFs/02%20-%20Como%20funciona%20a%20Internet.pdf).
...
![video_controls_width_700](../Content/SCREENSHOTS/video_controls_width_700.PNG)
...
![incorporado_yt](../Content/SCREENSHOTS/incorporado_yt.PNG)
...
![incorporado_vimeo](../Content/SCREENSHOTS/incorporado_vimeo.PNG)
...
![analogasrelacionada](../Content/SCREENSHOTS/triadicas.PNG)
...
![adobe color](../Content/SCREENSHOTS/adobecolor.PNG)
...
![justify](../Content/SCREENSHOTS/justify.PNG)
...
![shadowbox2](../Content/SCREENSHOTS/shadowbox2.PNG)
...
![marginauto](../Content/SCREENSHOTS/marginauto.PNG)
...
![colgroup](../Content/GIFS/colgroup.gif)
...
![googlemaps](../Content/SCREENSHOTS/googlemaps.PNG)
